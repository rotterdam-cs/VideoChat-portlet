 ...
 * @generated
 */
public abstract class ChatRoomLocalServiceBaseImpl
	...
	public ChatRoom addChatRoom(ChatRoom chatRoom) throws SystemException {
		...
		chatRoom = chatRoomPersistence.update(chatRoom, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(chatRoom);
			}
	...
	public void deleteChatRoom(long chatRoomId)
		...
		ChatRoom chatRoom = chatRoomPersistence.remove(chatRoomId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(chatRoom);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteChatRoom(ChatRoom chatRoom) throws SystemException {
		chatRoomPersistence.remove(chatRoom);
	...
	public ChatRoom updateChatRoom(ChatRoom chatRoom, boolean merge)
		...
		chatRoom = chatRoomPersistence.update(chatRoom, merge);
	...
	private static Log _log = LogFactoryUtil.getLog(ChatRoomLocalServiceBaseImpl.class);
