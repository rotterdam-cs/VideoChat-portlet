...
/**
 * The base implementation of the chat room group local service.
 *
 * <p>
...
public abstract class ChatRoomGroupLocalServiceBaseImpl
	implements ChatRoomGroupLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public ChatRoomGroup addChatRoomGroup(ChatRoomGroup chatRoomGroup)
		...
		chatRoomGroup = chatRoomGroupPersistence.update(chatRoomGroup, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(chatRoomGroup);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteChatRoomGroup(ChatRoomGroupPK chatRoomGroupPK)
		throws PortalException, SystemException {
		ChatRoomGroup chatRoomGroup = chatRoomGroupPersistence.remove(chatRoomGroupPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(chatRoomGroup);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteChatRoomGroup(ChatRoomGroup chatRoomGroup)
		throws SystemException {
		chatRoomGroupPersistence.remove(chatRoomGroup);
	...
	public ChatRoomGroup updateChatRoomGroup(ChatRoomGroup chatRoomGroup)
		throws SystemException {
		return updateChatRoomGroup(chatRoomGroup, true);
	}
	...
	public ChatRoomGroup updateChatRoomGroup(ChatRoomGroup chatRoomGroup,
		...
		chatRoomGroup = chatRoomGroupPersistence.update(chatRoomGroup, merge);
	 ...
	 */
	public ChatRoomGroupLocalService getChatRoomGroupLocalService() {
	...
	@BeanReference(type = ChatRoomGroupLocalService.class)
	protected ChatRoomGroupLocalService chatRoomGroupLocalService;
	...
	private static Log _log = LogFactoryUtil.getLog(ChatRoomGroupLocalServiceBaseImpl.class);
